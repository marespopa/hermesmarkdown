      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-bold mb-1 text-neutral-900 dark:text-white">Write</h3>
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Draft with markdown. Use <code className="bg-neutral-100 dark:bg-neutral-800 px-1 rounded text-xs">/</code> for templates.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-bold mb-1 text-neutral-900 dark:text-white">Refine</h3>
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
