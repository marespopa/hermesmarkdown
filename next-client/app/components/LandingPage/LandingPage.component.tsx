  ...
  return (
    <main data-testid="LandingPage" className="my-8">
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-2">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md max-w-md mx-auto mb-10 px-4 py-6 sm:px-8 sm:py-8 border border-gray-200 dark:border-gray-700">
