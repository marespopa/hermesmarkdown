  ...
  return (
    <main data-testid="LandingPage" className="my-8">
      <div className="container max-w-screen-xl mx-auto px-4 sm:px-2">
        ...
        <div className="mt-12 bg-white dark:bg-gray-800 rounded-xl shadow-md max-w-md mx-auto mb-16 px-6 py-8 sm:px-10 sm:py-10 border border-gray-200 dark:border-gray-700 flex flex-col gap-6">
          <div className="text-xs uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-4 text-center">Choose Your Path:</div>
          <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-gray-900 dark:text-white">Editing Options in Hermes Markdown</h1>
          <ul className="text-gray-700 dark:text-gray-300 text-center text-base sm:text-lg mb-8 flex flex-col gap-3 list-none">
