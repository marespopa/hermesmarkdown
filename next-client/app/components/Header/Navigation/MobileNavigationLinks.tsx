  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white dark:bg-neutral-900 bg-opacity-95 dark:bg-opacity-95">
      ...
      <div className="flex flex-col gap-3 w-full max-w-xs px-4">
        ...
        <button onClick={() => { handleClose(); window.location.href = "/documentation"; }} className="w-full py-2 px-5 border border-black dark:border-white bg-white dark:bg-gray-900 text-black dark:text-white rounded-none text-base hover:bg-black hover:text-white transition-colors">Documentation</button>
        ...
        <button onClick={() => { handleClose(); window.location.href = "/contact"; }} className="w-full py-2 px-5 border border-black dark:border-white bg-white dark:bg-gray-900 text-black dark:text-white rounded-none text-base hover:bg-black hover:text-white transition-colors">Contact</button>
